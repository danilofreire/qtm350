...
- ... and I was very happy with what I saw! 😊
...
:::{.column width="50%"}
:::{.incremental}
- Most the mistakes were actually [not related to this course's content at all!]{.alert}
...
- For a very good introduction to LLMs, I recommend [this article](https://writings.stephenwolfram.com/2023/02/what-is-chatgpt-doing-and-why-does-it-work/) by Stephen Wolfram
:::
...
:::{.columns}
:::{.column width="50%"}
- We will look into Copilot in more detail in the next lecture, but I wanted to make sure we all have it installed and ready to go 😉
...
- Copilot works in the CLI as well, and you can install it using [this guide](https://docs.github.com/en/copilot/using-github-copilot/using-github-copilot-in-the-command-line). You need to install the [GitHub CLI](https://cli.github.com/) first
