...
# Why bother with the shell? 🤷 {background-color="#2d4563"}
...
2. Create a new directory called "practice" and change into it: `mkdir practice
   && cd practice`
3. Create two empty files called "file1.txt" and "file2.txt": `touch file1.txt
   file2.txt`
