...
You will be asked to make your own copy of the lecture notes. You can add any name you like. I recommend you use the name same name I used for the repository (`datasci350`). This will make it easier to follow the instructions in the tutorials. Click on "Create fork".
