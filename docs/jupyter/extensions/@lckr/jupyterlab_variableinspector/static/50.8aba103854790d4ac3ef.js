...
`,Xr=q.Badge.compose({baseName:"badge",template:q.badgeTemplate,styles:Ur}),Zr=(e,t)=>xr.css`
  ${(0,q.display)("inline-block")} :host {
    box-sizing: border-box;
    font-family: ${ge};
    font-size: ${Ce};
...
`,Yr=q.Breadcrumb.compose({baseName:"breadcrumb",template:q.breadcrumbTemplate,styles:Zr}),Jr=(e,t)=>xr.css`
    ${(0,q.display)("inline-flex")} :host {
        background: transparent;
        box-sizing: border-box;
        font-family: ${ge};
...
`.withBehaviors((0,q.forcedColorsStylesheetBehavior)(xr.css`
  ...
  `.withBehaviors((0,q.forcedColorsStylesheetBehavior)(xr.css`
    ...
    `));class aa extends q.Card{connectedCallback(){super.connectedCallback();const e=(0,q.composedParent)(this);e&&Nt.setValueFor(this,(t=>Co.getValueFor(t).evaluate(t,Nt.getValueFor(e))))}}const ia=aa.compose({baseName:"card",baseClass:q.Card,template:q.cardTemplate,styles:ra}),la=(e,t)=>xr.css`
    ${(0,q.display)("inline-flex")} :host {
      align-items: center;
      outline: none;
...
`,ma=(e,t)=>xr.css`
  ...
  `.withBehaviors((0,q.forcedColorsStylesheetBehavior)(xr.css`
    ...
    `)),va=q.DataGridCell.compose({baseName:"data-grid-cell",template:q.dataGridCellTemplate,styles:ma}),$a=q.DataGridRow.compose({baseName:"data-grid-row",template:q.dataGridRowTemplate,styles:fa}),xa=q.DataGrid.compose({baseName:"data-grid",template:q.dataGridTemplate,styles:ba});var ya=o(291);class wa extends q.FoundationElement{}class ka extends((0,q.FormAssociated)(wa)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const Fa={toView(e){if(null==e)return null;const t=new Date(e);return"Invalid Date"===t.toString()?null:`${t.getFullYear().toString().padStart(4,"0")}-${(t.getMonth()+1).toString().padStart(2,"0")}-${t.getDate().toString().padStart(2,"0")}`},fromView(e){if(null==e)return null;const t=new Date(e);return"Invalid Date"===t.toString()?null:t}},Ca="Invalid Date";class Va extends ka{constructor(){super(...arguments),this.step=1,this.isUserInput=!1}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxChanged(e,t){var o;this.max=t<(null!==(o=this.min)&&void 0!==o?o:t)?this.min:t,this.value=this.getValidValue(this.value)}minChanged(e,t){var o;this.min=t>(null!==(o=this.max)&&void 0!==o?o:t)?this.max:t,this.value=this.getValidValue(this.value)}get valueAsNumber(){return new Date(super.value).valueOf()}set valueAsNumber(e){this.value=new Date(e).toString()}get valueAsDate(){return new Date(super.value)}set valueAsDate(e){this.value=e.toString()}valueChanged(e,t){this.value=this.getValidValue(t),t===this.value&&(this.control&&!this.isUserInput&&(this.control.value=this.value),super.valueChanged(e,this.value),void 0===e||this.isUserInput||this.$emit("change"),this.isUserInput=!1)}getValidValue(e){var t,o;let r=new Date(e);return r.toString()===Ca?r="":(r=r>(null!==(t=this.max)&&void 0!==t?t:r)?this.max:r,r=r<(null!==(o=this.min)&&void 0!==o?o:r)?this.min:r,r=`${r.getFullYear().toString().padStart(4,"0")}-${(r.getMonth()+1).toString().padStart(2,"0")}-${r.getDate().toString().padStart(2,"0")}`),r}stepUp(){const e=864e5*this.step,t=new Date(this.value);this.value=new Date(t.toString()!==Ca?t.valueOf()+e:0).toString()}stepDown(){const e=864e5*this.step,t=new Date(this.value);this.value=new Date(t.toString()!==Ca?Math.max(t.valueOf()-e,0):0).toString()}connectedCallback(){super.connectedCallback(),this.validate(),this.control.value=this.value,this.autofocus&&xr.DOM.queueUpdate((()=>{this.focus()})),this.appearance||(this.appearance="outline")}handleTextInput(){this.isUserInput=!0,this.value=this.control.value}handleChange(){this.$emit("change")}handleKeyDown(e){switch(e.key){case ya.I5:return this.stepUp(),!1;case ya.HX:return this.stepDown(),!1}return!0}handleBlur(){this.control.value=this.value}}Dr([xr.attr],Va.prototype,"appearance",void 0),Dr([(0,xr.attr)({attribute:"readonly",mode:"boolean"})],Va.prototype,"readOnly",void 0),Dr([(0,xr.attr)({mode:"boolean"})],Va.prototype,"autofocus",void 0),Dr([xr.attr],Va.prototype,"list",void 0),Dr([(0,xr.attr)({converter:xr.nullableNumberConverter})],Va.prototype,"step",void 0),Dr([(0,xr.attr)({converter:Fa})],Va.prototype,"max",void 0),Dr([(0,xr.attr)({converter:Fa})],Va.prototype,"min",void 0),Dr([xr.observable],Va.prototype,"defaultSlottedNodes",void 0),(0,q.applyMixins)(Va,q.StartEnd,q.DelegatesARIATextbox);const Da=xr.css`
  ${(0,q.display)("inline-block")} :host {
    font-family: ${ge};
    outline: none;
    user-select: none;
...
`,shadowOptions:{delegatesFocus:!0}}),Ta={toView:e=>null==e?null:null==e?void 0:e.toColorString(),fromView(e){if(null==e)return null;const t=f(e);return t?I.create(t.r,t.g,t.b):null}},za=xr.css`
  :host {
    background-color: ${Nt};
    color: ${Ho};
  }
`.withBehaviors((0,q.forcedColorsStylesheetBehavior)(xr.css`
  ...
  `));function ja(e){return(t,o)=>{t[o+"Changed"]=function(t,o){null!=o?e.setValueFor(this,o):e.deleteValueFor(this)}}}class Ba extends q.FoundationElement{constructor(){super(),this.noPaint=!1;const e={handleChange:this.noPaintChanged.bind(this)};xr.Observable.getNotifier(this).subscribe(e,"fillColor"),xr.Observable.getNotifier(this).subscribe(e,"baseLayerLuminance")}noPaintChanged(){this.noPaint||void 0===this.fillColor&&!this.baseLayerLuminance?this.$fastController.removeStyles(za):this.$fastController.addStyles(za)}}Dr([(0,xr.attr)({attribute:"no-paint",mode:"boolean"})],Ba.prototype,"noPaint",void 0),Dr([(0,xr.attr)({attribute:"fill-color",converter:Ta}),ja(Nt)],Ba.prototype,"fillColor",void 0),Dr([(0,xr.attr)({attribute:"accent-color",converter:Ta,mode:"fromView"}),ja(yt)],Ba.prototype,"accentColor",void 0),Dr([(0,xr.attr)({attribute:"neutral-color",converter:Ta,mode:"fromView"}),ja($t)],Ba.prototype,"neutralColor",void 0),Dr([(0,xr.attr)({attribute:"error-color",converter:Ta,mode:"fromView"}),ja(Eo)],Ba.prototype,"errorColor",void 0),Dr([(0,xr.attr)({converter:xr.nullableNumberConverter}),ja($e)],Ba.prototype,"density",void 0),Dr([(0,xr.attr)({attribute:"design-unit",converter:xr.nullableNumberConverter}),ja(xe)],Ba.prototype,"designUnit",void 0),Dr([(0,xr.attr)({attribute:"direction"}),ja(ye)],Ba.prototype,"direction",void 0),Dr([(0,xr.attr)({attribute:"base-height-multiplier",converter:xr.nullableNumberConverter}),ja(be)],Ba.prototype,"baseHeightMultiplier",void 0),Dr([(0,xr.attr)({attribute:"base-horizontal-spacing-multiplier",converter:xr.nullableNumberConverter}),ja(fe)],Ba.prototype,"baseHorizontalSpacingMultiplier",void 0),Dr([(0,xr.attr)({attribute:"control-corner-radius",converter:xr.nullableNumberConverter}),ja(ve)],Ba.prototype,"controlCornerRadius",void 0),Dr([(0,xr.attr)({attribute:"stroke-width",converter:xr.nullableNumberConverter}),ja(ke)],Ba.prototype,"strokeWidth",void 0),Dr([(0,xr.attr)({attribute:"focus-stroke-width",converter:xr.nullableNumberConverter}),ja(Fe)],Ba.prototype,"focusStrokeWidth",void 0),Dr([(0,xr.attr)({attribute:"disabled-opacity",converter:xr.nullableNumberConverter}),ja(we)],Ba.prototype,"disabledOpacity",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-minus-2-font-size"}),ja(Te)],Ba.prototype,"typeRampMinus2FontSize",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-minus-2-line-height"}),ja(ze)],Ba.prototype,"typeRampMinus2LineHeight",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-minus-1-font-size"}),ja(De)],Ba.prototype,"typeRampMinus1FontSize",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-minus-1-line-height"}),ja(Se)],Ba.prototype,"typeRampMinus1LineHeight",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-base-font-size"}),ja(Ce)],Ba.prototype,"typeRampBaseFontSize",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-base-line-height"}),ja(Ve)],Ba.prototype,"typeRampBaseLineHeight",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-1-font-size"}),ja(je)],Ba.prototype,"typeRampPlus1FontSize",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-1-line-height"}),ja(Be)],Ba.prototype,"typeRampPlus1LineHeight",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-2-font-size"}),ja(Le)],Ba.prototype,"typeRampPlus2FontSize",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-2-line-height"}),ja(He)],Ba.prototype,"typeRampPlus2LineHeight",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-3-font-size"}),ja(Ne)],Ba.prototype,"typeRampPlus3FontSize",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-3-line-height"}),ja(Oe)],Ba.prototype,"typeRampPlus3LineHeight",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-4-font-size"}),ja(Ie)],Ba.prototype,"typeRampPlus4FontSize",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-4-line-height"}),ja(Re)],Ba.prototype,"typeRampPlus4LineHeight",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-5-font-size"}),ja(Pe)],Ba.prototype,"typeRampPlus5FontSize",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-5-line-height"}),ja(Ae)],Ba.prototype,"typeRampPlus5LineHeight",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-6-font-size"}),ja(Me)],Ba.prototype,"typeRampPlus6FontSize",void 0),Dr([(0,xr.attr)({attribute:"type-ramp-plus-6-line-height"}),ja(Ge)],Ba.prototype,"typeRampPlus6LineHeight",void 0),Dr([(0,xr.attr)({attribute:"accent-fill-rest-delta",converter:xr.nullableNumberConverter}),ja(Ee)],Ba.prototype,"accentFillRestDelta",void 0),Dr([(0,xr.attr)({attribute:"accent-fill-hover-delta",converter:xr.nullableNumberConverter}),ja(_e)],Ba.prototype,"accentFillHoverDelta",void 0),Dr([(0,xr.attr)({attribute:"accent-fill-active-delta",converter:xr.nullableNumberConverter}),ja(qe)],Ba.prototype,"accentFillActiveDelta",void 0),Dr([(0,xr.attr)({attribute:"accent-fill-focus-delta",converter:xr.nullableNumberConverter}),ja(We)],Ba.prototype,"accentFillFocusDelta",void 0),Dr([(0,xr.attr)({attribute:"accent-foreground-rest-delta",converter:xr.nullableNumberConverter}),ja(Ue)],Ba.prototype,"accentForegroundRestDelta",void 0),Dr([(0,xr.attr)({attribute:"accent-foreground-hover-delta",converter:xr.nullableNumberConverter}),ja(Xe)],Ba.prototype,"accentForegroundHoverDelta",void 0),Dr([(0,xr.attr)({attribute:"accent-foreground-active-delta",converter:xr.nullableNumberConverter}),ja(Ze)],Ba.prototype,"accentForegroundActiveDelta",void 0),Dr([(0,xr.attr)({attribute:"accent-foreground-focus-delta",converter:xr.nullableNumberConverter}),ja(Ye)],Ba.prototype,"accentForegroundFocusDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-rest-delta",converter:xr.nullableNumberConverter}),ja(Je)],Ba.prototype,"neutralFillRestDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-hover-delta",converter:xr.nullableNumberConverter}),ja(Ke)],Ba.prototype,"neutralFillHoverDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-active-delta",converter:xr.nullableNumberConverter}),ja(Qe)],Ba.prototype,"neutralFillActiveDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-focus-delta",converter:xr.nullableNumberConverter}),ja(et)],Ba.prototype,"neutralFillFocusDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-input-rest-delta",converter:xr.nullableNumberConverter}),ja(tt)],Ba.prototype,"neutralFillInputRestDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-input-hover-delta",converter:xr.nullableNumberConverter}),ja(ot)],Ba.prototype,"neutralFillInputHoverDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-input-active-delta",converter:xr.nullableNumberConverter}),ja(rt)],Ba.prototype,"neutralFillInputActiveDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-input-focus-delta",converter:xr.nullableNumberConverter}),ja(at)],Ba.prototype,"neutralFillInputFocusDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-stealth-rest-delta",converter:xr.nullableNumberConverter}),ja(it)],Ba.prototype,"neutralFillStealthRestDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-stealth-hover-delta",converter:xr.nullableNumberConverter}),ja(lt)],Ba.prototype,"neutralFillStealthHoverDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-stealth-active-delta",converter:xr.nullableNumberConverter}),ja(nt)],Ba.prototype,"neutralFillStealthActiveDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-stealth-focus-delta",converter:xr.nullableNumberConverter}),ja(st)],Ba.prototype,"neutralFillStealthFocusDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-strong-hover-delta",converter:xr.nullableNumberConverter}),ja(dt)],Ba.prototype,"neutralFillStrongHoverDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-strong-active-delta",converter:xr.nullableNumberConverter}),ja(ht)],Ba.prototype,"neutralFillStrongActiveDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-strong-focus-delta",converter:xr.nullableNumberConverter}),ja(ut)],Ba.prototype,"neutralFillStrongFocusDelta",void 0),Dr([(0,xr.attr)({attribute:"base-layer-luminance",converter:xr.nullableNumberConverter}),ja(me)],Ba.prototype,"baseLayerLuminance",void 0),Dr([(0,xr.attr)({attribute:"neutral-fill-layer-rest-delta",converter:xr.nullableNumberConverter}),ja(pt)],Ba.prototype,"neutralFillLayerRestDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-stroke-divider-rest-delta",converter:xr.nullableNumberConverter}),ja(vt)],Ba.prototype,"neutralStrokeDividerRestDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-stroke-rest-delta",converter:xr.nullableNumberConverter}),ja(gt)],Ba.prototype,"neutralStrokeRestDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-stroke-hover-delta",converter:xr.nullableNumberConverter}),ja(bt)],Ba.prototype,"neutralStrokeHoverDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-stroke-active-delta",converter:xr.nullableNumberConverter}),ja(ft)],Ba.prototype,"neutralStrokeActiveDelta",void 0),Dr([(0,xr.attr)({attribute:"neutral-stroke-focus-delta",converter:xr.nullableNumberConverter}),ja(mt)],Ba.prototype,"neutralStrokeFocusDelta",void 0);const La=(e,t)=>xr.html` <slot></slot> `,Ha=(e,t)=>xr.css`
  ${(0,q.display)("block")}
`,Na=Ba.compose({baseName:"design-system-provider",template:La,styles:Ha}),Oa=(e,t)=>xr.css`
  :host([hidden]) {
    display: none;
  }
...
`,Ia=q.Dialog.compose({baseName:"dialog",template:q.dialogTemplate,styles:Oa}),Ra=(e,t)=>xr.css`
  .disclosure {
...
`,Ga=q.Divider.compose({baseName:"divider",template:q.dividerTemplate,styles:Ma});class Ea extends q.ListboxElement{sizeChanged(e,t){super.sizeChanged(e,t),this.updateComputedStylesheet()}updateComputedStylesheet(){this.computedStylesheet&&this.$fastController.removeStyles(this.computedStylesheet);const e=`${this.size}`;this.computedStylesheet=xr.css`
  ...
  `.withBehaviors((0,q.forcedColorsStylesheetBehavior)(xr.css`
    ...
    `));class Wa extends q.Menu{connectedCallback(){super.connectedCallback(),Nt.setValueFor(this,Vt)}}const Ua=Wa.compose({baseName:"menu",template:q.menuTemplate,styles:qa}),Xa=(e,t)=>xr.css`
  ...
  `.withBehaviors((0,q.forcedColorsStylesheetBehavior)(xr.css`
    ...
    `),new Mr(xr.css`
      ...
      `)),Za=q.MenuItem.compose({baseName:"menu-item",template:q.menuItemTemplate,styles:Xa,checkboxIndicator:'\n        <svg\n            part="checkbox-indicator"\n            class="checkbox-indicator"\n            viewBox="0 0 20 20"\n            xmlns="http://www.w3.org/2000/svg"\n        >\n            <path\n                fill-rule="evenodd"\n                clip-rule="evenodd"\n                d="M8.143 12.6697L15.235 4.5L16.8 5.90363L8.23812 15.7667L3.80005 11.2556L5.27591 9.7555L8.143 12.6697Z"\n            />\n        </svg>\n    ',expandCollapseGlyph:'\n        <svg\n            viewBox="0 0 16 16"\n            xmlns="http://www.w3.org/2000/svg"\n            class="expand-collapse-glyph"\n            part="expand-collapse-glyph"\n        >\n            <path\n                d="M5.00001 12.3263C5.00124 12.5147 5.05566 12.699 5.15699 12.8578C5.25831 13.0167 5.40243 13.1437 5.57273 13.2242C5.74304 13.3047 5.9326 13.3354 6.11959 13.3128C6.30659 13.2902 6.4834 13.2152 6.62967 13.0965L10.8988 8.83532C11.0739 8.69473 11.2153 8.51658 11.3124 8.31402C11.4096 8.11146 11.46 7.88966 11.46 7.66499C11.46 7.44033 11.4096 7.21853 11.3124 7.01597C11.2153 6.81341 11.0739 6.63526 10.8988 6.49467L6.62967 2.22347C6.48274 2.10422 6.30501 2.02912 6.11712 2.00691C5.92923 1.9847 5.73889 2.01628 5.56823 2.09799C5.39757 2.17969 5.25358 2.30817 5.153 2.46849C5.05241 2.62882 4.99936 2.8144 5.00001 3.00369V12.3263Z"\n            />\n        </svg>\n    ',radioIndicator:'\n        <span part="radio-indicator" class="radio-indicator"></span>\n    '}),Ya=(e,t)=>xr.css`
  ${Da}
...
`;class Ja extends q.NumberField{constructor(){super(...arguments),this.appearance="outline"}}Dr([xr.attr],Ja.prototype,"appearance",void 0);const Ka=Ja.compose({baseName:"number-field",baseClass:q.NumberField,styles:Ya,template:q.numberFieldTemplate,shadowOptions:{delegatesFocus:!0},stepDownGlyph:'\n        <span class="step-down-glyph" part="step-down-glyph"></span>\n    ',stepUpGlyph:'\n        <span class="step-up-glyph" part="step-up-glyph"></span>\n    '}),Qa=(e,t)=>xr.css`
    ${(0,q.display)("inline-flex")} :host {
      align-items: center;
      font-family: ${ge};
      border-radius: calc(${ve} * 1px);
...
`,zi=(e,t)=>xr.css`
  ...
  `.withBehaviors((0,q.forcedColorsStylesheetBehavior)(xr.css`
    ...
    `));class ji extends q.SliderLabel{sliderOrientationChanged(){this.sliderOrientation===Di.t.horizontal?(this.$fastController.addStyles(Si),this.$fastController.removeStyles(Ti)):(this.$fastController.addStyles(Ti),this.$fastController.removeStyles(Si))}}const Bi=ji.compose({baseName:"slider-label",baseClass:q.SliderLabel,template:q.sliderLabelTemplate,styles:zi}),Li=(e,t)=>xr.css`
    :host([hidden]) {
      display: none;
    }
  ...
  `.withBehaviors((0,q.forcedColorsStylesheetBehavior)(xr.css`
    ...
    `),new Mr(xr.css`
      ...
      `));class Hi extends q.Switch{}const Ni=Hi.compose({baseName:"switch",baseClass:q.Switch,template:q.switchTemplate,styles:Li,switch:'\n        <span class="checked-indicator" part="checked-indicator"></span>\n    '}),Oi=(e,t)=>xr.css`
  ${(0,q.display)("block")} :host {
    box-sizing: border-box;
    font-size: ${Ce};
    line-height: ${Ve};
...
`,Ii=q.TabPanel.compose({baseName:"tab-panel",template:q.tabPanelTemplate,styles:Oi}),Ri=(e,t)=>xr.css`
    ${(0,q.display)("inline-flex")} :host {
      box-sizing: border-box;
      font-family: ${ge};
      font-size: ${Ce};
  ...
  `.withBehaviors((0,q.forcedColorsStylesheetBehavior)(xr.css`
    ...
    `)),Pi=q.Tab.compose({baseName:"tab",template:q.tabTemplate,styles:Ri}),Ai=(e,t)=>xr.css`
    ${(0,q.display)("grid")} :host {
      box-sizing: border-box;
      font-family: ${ge};
      font-size: ${Ce};
...
`;class Wi extends q.TextField{constructor(){super(...arguments),this.appearance="outline"}}Dr([xr.attr],Wi.prototype,"appearance",void 0);const Ui=Wi.compose({baseName:"text-field",baseClass:q.TextField,template:q.textFieldTemplate,styles:qi,shadowOptions:{delegatesFocus:!0}});var Xi=o(21),Zi=o(54);const Yi=(e,t)=>xr.css`
    ${(0,q.display)("inline-flex")} :host {
...
`,gl=(e,t)=>xr.css`
  ...
  `.withBehaviors((0,q.forcedColorsStylesheetBehavior)(xr.css`
    ...
    `))}),wl=q.PickerListItem.compose({baseName:"draft-picker-list-item",template:q.pickerListItemTemplate,styles:fl}),kl={jpAccordion:Vr,jpAccordionItem:Cr,jpAnchor:Rr,jpAnchoredRegion:Ar,jpAvatar:Wr,jpBadge:Xr,jpBreadcrumb:Yr,jpBreadcrumbItem:Kr,jpButton:ta,jpCard:ia,jpCheckbox:ca,jpCombobox:ga,jpDataGrid:xa,jpDataGridCell:va,jpDataGridRow:$a,jpDateField:Sa,jpDesignSystemProvider:Na,jpDialog:Ia,jpDisclosure:Aa,jpDivider:Ga,jpListbox:_a,jpMenu:Ua,jpMenuItem:Za,jpNumberField:Ka,jpOption:ei,jpPicker:ml,jpPickerList:yl,jpPickerListItem:wl,jpPickerMenu:$l,jpPickerMenuOption:xl,jpProgress:oi,jpProgressRing:ai,jpRadio:si,jpRadioGroup:hi,jpSearch:fi,jpSelect:$i,jpSkeleton:yi,jpSlider:Vi,jpSliderLabel:Bi,jpSwitch:Ni,jpTab:Pi,jpTabPanel:Ii,jpTabs:Mi,jpTextArea:_i,jpTextField:Ui,jpToolbar:tl,jpTooltip:rl,jpTreeItem:dl,jpTreeView:ul,register(e,...t){if(e)for(const o in this)"register"!==o&&this[o]().register(e,...t)}};function Fl(e){return q.DesignSystem.getOrCreate(e).withPrefix("jp")}}}]);