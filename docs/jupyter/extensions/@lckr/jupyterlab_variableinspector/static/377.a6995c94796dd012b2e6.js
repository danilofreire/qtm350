...
`;class Ut extends yt{constructor(){super(...arguments),this.separator=!0}}d([s.observable],Ut.prototype,"separator",void 0),dt(Ut,o,Ct);const jt=(t,e)=>s.html`
...
`;class _t extends rt{slottedBreadcrumbItemsChanged(){if(this.$fastController.isConnected){if(void 0===this.slottedBreadcrumbItems||0===this.slottedBreadcrumbItems.length)return;const t=this.slottedBreadcrumbItems[this.slottedBreadcrumbItems.length-1];this.slottedBreadcrumbItems.forEach((e=>{const i=e===t;this.setItemSeparator(e,i),this.setAriaCurrent(e,i)}))}}setItemSeparator(t,e){t instanceof Ut&&(t.separator=!e)}findChildWithHref(t){var e,i;return t.childElementCount>0?t.querySelector("a[href]"):(null===(e=t.shadowRoot)||void 0===e?void 0:e.childElementCount)?null===(i=t.shadowRoot)||void 0===i?void 0:i.querySelector("a[href]"):null}setAriaCurrent(t,e){const i=this.findChildWithHref(t);null===i&&t.hasAttribute("href")&&t instanceof Ut?e?t.setAttribute("aria-current","page"):t.removeAttribute("aria-current"):null!==i&&(e?i.setAttribute("aria-current","page"):i.removeAttribute("aria-current"))}}d([s.observable],_t.prototype,"slottedBreadcrumbItems",void 0);const Kt=(t,e)=>s.html`
    <button
        class="control"
        part="control"
...
`,qe=(t,e)=>{const i=function(t){const e=t.tagFor(ce);return s.html`
    <${e}
        :rowData="${t=>t}"
...
`}(t),o=t.tagFor(ce);return s.html`
    ...
    `},Ue=(t,e)=>{const i=function(t){const e=t.tagFor(de);return s.html`
    <${e}
...
`;var Ei=i(2);const Ri={separator:"separator",presentation:"presentation"};class Di extends rt{constructor(){super(...arguments),this.role=Ri.separator,this.orientation=Ei.t.horizontal}}d([s.attr],Di.prototype,"role",void 0),d([s.attr],Di.prototype,"orientation",void 0);const Si={next:"next",previous:"previous"},Fi=(t,e)=>s.html`
    <template
        role="button"
