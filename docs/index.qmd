...
This course will introduce students to key tools in the modern data science
workflow, focusing on three Rs that are essential for success in data science:
_reliability_, _reproducibility_, and _robustness_. The course will cover the
following topics: 1) command line interfaces and vim; 2) version control with
Git and GitHub; 3) literate programming and reproducible research with Quarto
and Jupyter Notebooks; 4) data storage and manipulation with SQL and Pandas; 5) data visualisation with Matplotlib, Seaborn and plotnine; 6) parallel computing with Dask; 7) GitHub Co-Pilot and AI-assisted programming; 8) Docker and containerisation.
...
- Prerequisites: Some knowledge of Python or R is recommended, and familiarity with basic data manipulation and visualisation techniques is helpful. No prior experience with the tools covered in the course is required.
...
License](https://github.com/danilofreire/qtm350/blob/main/LICENSE.md). You are
